sap.ui.define([
    ...
    return BaseController.extend("ui5fhir.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("family", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "ui5fhir.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1" :
                        aFilters.push(new Filter("birthdate", FilterOperator.GT, "gt1989-09-11"));
                        break;
                    case "Filter2" :
                        aFilters.push(new Filter("birthdate", FilterOperator.LE, "le1989-09-11"));
                        break;
                    default :
                        break;
                }
